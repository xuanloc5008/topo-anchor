...
from topoanchor.topology.cache import write_cache_record, write_jsonl, write_vector_npz
...
def main(cfg: DictConfig) -> None:
    ...
    for manifest in manifests:
        ...
        print(f"Wrote topology cache for {len(records)} samples from {manifest_path}.")
